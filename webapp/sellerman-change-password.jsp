...
<%@include file="sellerman-navbar.jsp"%>
<!DOCTYPE html>
<html>
<head>
<!-- Meta Tag -->
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html">Change
									Password</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<form class="form" method="post" action="SellermanController">
								<div class="row">
									<%
									...
									<div class="col-12">
										...
										<input type="hidden" name="email" value = "<%= sm.getEmail() %>">

										<div class="form-group">
											<label>Your Old Password<span>*</span></label> <input
												name="op" type="password" placeholder="">
										</div>
									</div>

									<div class="col-12">
										<div class="form-group">
											<label>Your New Password<span>*</span></label> <input
												name="np" type="password" placeholder="">
										</div>
									</div>

									<div class="col-12">
										<div class="form-group">
											<label>Your Confirm New Password<span>*</span></label> <input
												name="cnp" type="password" placeholder="">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group button">
											<button type="submit" class="btn" name="action"
												value="updatepassword">Update Password</button>
