		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<div class="row">
					<%List<ProductModel> list = Productdao.allproducts(); %>
					<%for(ProductModel m1 : list){ %>
						<div class="col-lg-4 col-md-6 col-12">
							<div class="single-product">
								<div class="product-img">
									<a href="product-details.html"> <img class="default-img"
										src="img/<%= m1.getPimage() %>" alt="#"> <img
								...
								<div class="product-content">
									<h3>
										<a href="single-product.jsp?pid=<%= m1.getPid() %>"><%= m1.getPname() %>(256GB) - Purple</a>
									</h3>
									<div class="product-price">
										<span><%= m1.getPprice() %></span>
									</div>
								</div>
							</div>
						</div>
