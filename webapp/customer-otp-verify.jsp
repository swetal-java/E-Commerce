				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html">Forgot Password</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="row">
									...
									<div class="col-12">
										...
										<input type="hidden" name="otp1" value="<%= otp %>">
											<label>Your OTP<span></span></label> <input name="otp2"
									...
									<div class="col-12">
										<div class="form-group button">
											<button type="submit" class="btn" name="action" value="verifyotp">Verify OTP</button>
										</div>
									</div>
